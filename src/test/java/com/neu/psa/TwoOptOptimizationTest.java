...
public class TwoOptOptimizationTest {
	...
	public void newTourVertices() throws IOException {
		...
		ChristofidesTour twoOptTour = TSPMainProgram.christofidesAlgorithm(INPUT_FILENAME, 2, "twoOpt");
	...
	public void compareDistance() throws IOException {
		...
		ChristofidesTour newChristofidesTour = TSPMainProgram.christofidesAlgorithm(INPUT_FILENAME, 2, "twoOpt");
